import { ChangeDetectorRef, Component, EventEmitter, forwardRef, Input, Output, ContentChild, TemplateRef, ElementRef, ViewChildren, ViewChild } from '@angular/core';
...
export class NgSelectCustomComponent implements ControlValueAccessor, OnInit {
  ...
  @Input()
  set Init(obj: any) {
    if (this.SearchEntity == null) this.SearchEntity = new FilterEntity();
